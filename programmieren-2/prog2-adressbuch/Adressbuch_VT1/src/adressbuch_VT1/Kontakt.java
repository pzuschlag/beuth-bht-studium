 ...
 */
public class Kontakt implements Comparable<adressbuch_VT2.Kontakt> {
    ...
    public boolean equals(Object jenes) {
        ...
        if (!(jenes instanceof adressbuch_VT2.Kontakt)) {
            return false;
        }
        adressbuch_VT2.Kontakt jenerKontakt = (adressbuch_VT2.Kontakt) jenes;
     ...
     */
    public int compareTo(adressbuch_VT2.Kontakt jenerKontakt) {
