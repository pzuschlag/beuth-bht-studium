...
public class BufferedAppointmetReaderTest {
	...
	public void setUp() throws Exception {
		...
		BufferedAppointmentWriter.writeEntityList(appointments, "resources/jUnit/appointments.csv", ":");

		appointmentsRead = BufferedAppointmentReader.readEntityList("resources/jUnit/appointments.csv", ":");
	}
