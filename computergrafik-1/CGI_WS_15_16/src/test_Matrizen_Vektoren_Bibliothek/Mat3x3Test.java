package src.test_Matrizen_Vektoren_Bibliothek;
...
import src.Matrizen_Vektoren_Bibliothek.Mat3x3;
import src.Matrizen_Vektoren_Bibliothek.Point3;
import src.Matrizen_Vektoren_Bibliothek.Vector3;
...
public class Mat3x3Test {
	...
	public void testChangeCol1() throws Exception {
		...
		assertTrue(m1.changeCol1(v1).equals(
				new Mat3x3(8, 2, 3, 8, 5, 6, 8, 8, 9)));
	}
	...
	public void testChangeCol2() throws Exception {
		...
		// + "\n");
		assertTrue(m1.changeCol2(v1).equals(
				new Mat3x3(1, 8, 3, 4, 8, 6, 7, 8, 9)));
	}
	...
	public void testChangeCol3() throws Exception {
		...
		assertTrue(m1.changeCol3(v1).equals(
				new Mat3x3(1, 2, 8, 4, 5, 8, 7, 8, 8)));
	}
