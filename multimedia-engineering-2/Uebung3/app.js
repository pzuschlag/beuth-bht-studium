...
/**
 * Route for PATCH in order to change one single attribute of an existing object
 */
 ...
 * @param tweet: object to which we add the href
 ...
 * @param user: object to which we add the href
